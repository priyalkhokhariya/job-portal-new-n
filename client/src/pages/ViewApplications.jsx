            ...
            <table className='w-full max-w-4xl bg-white border border-gray-200 max-sm:text-sm'>
                <thead>
                    <tr className='border-b'>
                        ...
                        <th className='py-4 px-6 text-left max-sm:hidden'>Job Title</th>
                        <th className='py-4 px-6 text-left max-sm:hidden'>Location</th>
                ...
                <tbody>
                    {viewApplicationsPageData.map((applicant,index)=> (
                        <tr key={index} className='text-gray-700 hover:bg-gray-50'>
                            ...
                            <td className='py-4 px-6 border-b max-sm:hidden'>{applicant.jobTitle}</td>
                            <td className='py-4 px-6 border-b max-sm:hidden'>{applicant.location}</td>
                            <td className='py-4 px-6 border-b'>
