...
const Applyjob = () => {
  ...
  return JobData ?(
    <> 
       <Navbar/>
       <div className='min-h-screen flex flex-col py-10 px-2 md:px-6 max-w-[1200px] mx-auto'>
                ...
                <div className='flex justify-center md:justify-between flex-wrap gap-8 px-14 py-20 bg-sky-50 border border-sky-400 rounded-xl'>
                     <div className='flex flex-col md:flex-row items-center'>
                         ...
                         <div className='text-center md:text-left text-neutral-700'>
                               <h1 className='text-2xl sm:text-4xl font font-medium'>{JobData.title}</h1>
                 ...
                 <div className='flex flex-col lg:flex-row justify-between items-start'>
                       <div className='w-full lg:w-2/3'>
                           <h2 className='font-bold text-2xl mb-4 mt-8'>Job Description</h2>

                           <div className='rich-text' dangerouslySetInnerHTML={{__html:JobData.description}}></div>
                           <button className='bg-blue-600 p-2.5 px-10 text-white rounded mt-10'>Apply Now</button>
                       </div>

                       {/* right section of jobs */}
                       <div className='w-full lg:w-1/3 mt-8 lg:mt-0 lg:ml-8 space-y-5'>
                             <h2 className='mt-8 mb-4'>More jobs from {JobData.companyId.name}</h2>
